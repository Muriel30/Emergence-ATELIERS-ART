...
ActiveRecord::Schema.define(version: 20171211195821) do
  ...
  create_table "studios", force: :cascade do |t|
    ...
    t.datetime "created_at",          null: false
    t.datetime "updated_at",          null: false
    t.integer  "artisan_category_id"
    t.index ["artisan_category_id"], name: "index_studios_on_artisan_category_id", using: :btree
  end
  ...
  add_foreign_key "studios", "artisan_categories"
